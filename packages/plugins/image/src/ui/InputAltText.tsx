          ...
          <div className="yoopta-image-input-root yoo-image-shadow-y-[4px]">
            <div>
              ...
              <input
                ...
                placeholder={'getLabelText' in editor ? (editor as any).getLabelText('plugins.Image.placeholders.editAlt') : 'Edit alt text'}
                autoComplete="off"
              />
            </div>
            ...
            <div className="yoo-image-mt-2 yoo-image-flex yoo-image-justify-between">
              <button
                ...
                onClick={onSave}>
                {'getLabelText' in editor
                  ? (editor as any).getLabelText('editor.common.update')
                  : 'Update'}
              </button>
              <button
                type="button"
                ...
                onClick={onDelete}>
                {'getLabelText' in editor
                  ? (editor as any).getLabelText('editor.common.delete')
                  : 'Delete'}
              </button>
            </div>
          </div>
